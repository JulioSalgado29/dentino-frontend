            ...
            <Table>
                <thead>
                    <tr>
                        ...
                        <th className="row2" style={{ textAlign: "center", verticalAlign: "middle", display: "none" }}>Estado</th>
                ...
                <tbody>
                    {datos.map((dato) => (
                        ...
                        <tr key={dato.id} style={{ borderTop: "1px solid #e9ecef", borderBottomWidth: "1px" }}>
                            ...
                            <td className="row4" style={{ textAlign: "center", verticalAlign: "middle" }}>{dato.direccion}</td>
                            <td className="row2" style={{ textAlign: "center", verticalAlign: "middle" }}>{dato.aforo}</td>
                            <td className="row1" style={{ textAlign: "center", verticalAlign: "middle", display: "none" }}>{dato.estado}</td>
