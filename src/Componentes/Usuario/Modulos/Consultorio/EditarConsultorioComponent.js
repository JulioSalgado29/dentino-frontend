...
class EditarConsultorioComponent extends React.Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      estado: JSON.parse(localStorage.getItem("dato")).estado,
    ...
    this.editConsultorio = this.editConsultorio.bind(this);
  ...
  editConsultorio(e) {
    ...
    if (this.checkBtn.context._errors.length === 0) {
      Swal.fire
        ({
          title: "Estas seguro de editar al consultorio: '" + JSON.parse(localStorage.getItem("dato")).nombre + "'",
          icon: 'warning',
          ...
          if (result.value) {
            ConsultorioService.editarConsultorio(this.state.id, this.state.codigo, this.state.nombre, this.state.direccion, this.state.aforo, this.state.estado)
              .then(() => {
                Swal.fire
                  ({
        ...
        <div className="content-wrapper" style={{ background: "white" }}>
          <div className="container-modulos">
            <div className="wrap-register200" style={{ width: '' }}>
              <span className="login100-form-title">Actualizar Consultorio</span>
              <Form className="register100-form validate-form" style={{ display: "contents" }} onSubmit={this.editTrabajador} ref={c => { this.form = c; }}>
                ...
                <div className="container-login100-form-btn">
                  <button className="registrar100-form-btn" onClick={this.editConsultorio} style={{ maxWidth: "1140px" }}
...
export default EditarConsultorioComponent